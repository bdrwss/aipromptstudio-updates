...
export default function handler(req, res) {
  ...
  const LATEST_VERSION = {
    ...
    file_size: 52428800, // 50MB，需要根据实际文件大小修改
    checksum: "sha256:abc123def456...", // 需要计算实际文件的SHA256
    release_notes: "🚀 AI Prompt Studio v1.1.0\n\n✨ 新功能:\n- 强制自动更新功能\n- 优化用户界面\n- 提升性能\n\n🐛 修复:\n- 修复若干已知问题\n- 提升稳定性",
    force_update: true,  // 强制更新
    min_version: "1.0.0", // 最低支持版本
    release_date: "2025-01-16T10:00:00Z",
    download_mirrors: [
      // 备用下载地址（可选）
      "https://github.com/bdrwss/aipromptstudio-updates/releases/download/v1.1.0/AIPromptStudio-1.1.0-Setup.exe"
    ]
  };
